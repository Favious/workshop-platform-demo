...
export default function CreateOrderPage() {
  ...
  const onSubmit = async (e) => {
    ...
    formData.plateNumber = formData.plateNumber.toUpperCase();
    ...
    const docRef = await addDoc(ordersCollectionsRef, {
      ...formData,
      billDate: dateValue,
      time: new Date(),
      createdAt: new Date(),
    ...
    let imgUrls = await uploadImagesAndRetrieveLinks(imagesAsFiles, docRef.id);
        ...
        <div className="row">
          <div className="submit-button">
            <button type="submit" disabled={loading}>
              {loading ? <BeatLoader color="#ffffff" /> : "Registrar orden"}
            </button>
          </div>
        </div>
      </form>
